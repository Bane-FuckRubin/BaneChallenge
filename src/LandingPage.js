...
render(){
  return (
    ...
    {this.state.pressed===true &&
      <div style={{}}>
        <h3 style={{fontSize:'6rem',paddingTop:'2rem'}}>Into the pit you go David. Scroll down to start.</h3>
        ...
        <h3 style={{fontSize:'6rem',paddingTop:'2rem',paddingBottom:'100rem'}}>↓</h3> 
        <h3 style={{fontSize:'3rem'}}>If you are ready to try and earn your way out click on Mario to start.</h3>
