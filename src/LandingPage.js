...
render(){
  return (
    ...
    <img  style={{width:'20rem',height:'20rem'}}src={Davidphoto}></img>
    </span></div>
    }
    ...
    <div>
     ...
     <Link to='/Challenge1'><img onClick={<sendMessage message="this is a test"/>} src={WeirdMario} style={{maxHeight:'20rem',maxWidth:'20rem'}}/> </Link>
    </div>}
    </div>
  );
}
